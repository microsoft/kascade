...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(half_t* __restrict__ K, __grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, half_t* __restrict__ Q, half_t* __restrict__ V, __grid_constant__ const CUtensorMap V_desc, int* __restrict__ head_mapping, int* __restrict__ topk_indices, int batch, int seq_len, int topk_num) {
  ...
  if (256 <= ((int)threadIdx.x)) {
      ...
      if (((((seq_len + 31) >> 5) * 32) - (((int)blockIdx.x) * 32)) <= (topk_num + 32)) {
        ...
        if (((k * 128) + 128) <= topk_num) {
          ...
          for (int i_1 = 0; i_1 < 16; ++i_1) {
            tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((k & 1) * 32768) + (((((int)tidx) & 15) >> 3) * 16384)) + (i_1 * 1024)) + ((((int)tidx) >> 4) * 128)) + ((((((int)tidx) >> 6) + ((((int)tidx) & 7) >> 2)) & 1) * 64)) + (((((((int)tidx) & 63) >> 5) + ((((int)tidx) & 3) >> 1)) & 1) * 32)) + (((((((int)tidx) & 31) >> 4) + (((int)tidx) & 1)) & 1) * 16)) - 1024), K+((((((int64_t)topk_indices[(((((((((int64_t)k) * (int64_t)128) + (((((int64_t)((int)blockIdx.z)) * ((int64_t)topk_num)) * ((((int64_t)seq_len) + (int64_t)31) >> (int64_t)5)) * (int64_t)8)) + (((int64_t)i_1) * (int64_t)8)) + (((int64_t)((int)tidx)) >> (int64_t)4)) + ((((int64_t)head_to_reuse) * ((int64_t)topk_num)) * ((((int64_t)seq_len) + (int64_t)31) >> (int64_t)5))) + (((((((int64_t)seq_len) + (int64_t)31) >> (int64_t)5) - ((int64_t)((int)blockIdx.x))) - (int64_t)1) * ((int64_t)topk_num))) - (int64_t)8)]) * (int64_t)1024) + ((((int64_t)((int)blockIdx.z)) * ((int64_t)seq_len)) * (int64_t)1024)) + (((int64_t)((int)blockIdx.y)) * (int64_t)128)) + ((((int64_t)((int)tidx)) & (int64_t)15) * (int64_t)8)));
          }
        } else {
            if (tl::tl_shuffle_elect<128>()) {
              mbarrier[(k & 1)].expect_transaction(32768);
      ...
      if (((((seq_len + 31) >> 5) * 32) - (((int)blockIdx.x) * 32)) <= (topk_num + 32)) {
        ...
        if (((k * 128) + 128) <= topk_num) {
          ...
          for (int i_3 = 0; i_3 < 16; ++i_3) {
            tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((k & 1) * 32768) + (((((int)tidx) & 15) >> 3) * 16384)) + (i_3 * 1024)) + ((((int)tidx) >> 4) * 128)) + ((((((int)tidx) >> 6) + ((((int)tidx) & 7) >> 2)) & 1) * 64)) + (((((((int)tidx) & 63) >> 5) + ((((int)tidx) & 3) >> 1)) & 1) * 32)) + (((((((int)tidx) & 31) >> 4) + (((int)tidx) & 1)) & 1) * 16)) + 64512), V+((((((int64_t)topk_indices[(((((((((int64_t)k) * (int64_t)128) + (((((int64_t)((int)blockIdx.z)) * ((int64_t)topk_num)) * ((((int64_t)seq_len) + (int64_t)31) >> (int64_t)5)) * (int64_t)8)) + (((int64_t)i_3) * (int64_t)8)) + (((int64_t)((int)tidx)) >> (int64_t)4)) + ((((int64_t)head_to_reuse) * ((int64_t)topk_num)) * ((((int64_t)seq_len) + (int64_t)31) >> (int64_t)5))) + (((((((int64_t)seq_len) + (int64_t)31) >> (int64_t)5) - ((int64_t)((int)blockIdx.x))) - (int64_t)1) * ((int64_t)topk_num))) - (int64_t)8)]) * (int64_t)1024) + ((((int64_t)((int)blockIdx.z)) * ((int64_t)seq_len)) * (int64_t)1024)) + (((int64_t)((int)blockIdx.y)) * (int64_t)128)) + ((((int64_t)((int)tidx)) & (int64_t)15) * (int64_t)8)));
          }
        } else {
            if (tl::tl_shuffle_elect<128>()) {
              mbarrier[((k & 1) + 2)].expect_transaction(32768);
    ...
    int condval_2;
    if ((((((seq_len + 31) >> 5) * 32) - (((int)blockIdx.x) * 32)) <= (topk_num + 32))) {
      condval_2 = ((((((seq_len + 31) >> 5) * 32) + 127) - (((int)blockIdx.x) * 32)) >> 7);
    } else {
      condval_2 = (((topk_num + 127) >> 7) + 1);
    }
    for (int k_1 = 0; k_1 < condval_2; ++k_1) {
      if (((((seq_len + 31) >> 5) * 32) - (((int)blockIdx.x) * 32)) <= (topk_num + 32)) {
        #pragma unroll
        for (int i_8 = 0; i_8 < 64; ++i_8) {
          ...
          acc_s[(((((i_8 & 31) >> 1) * 4) + ((i_8 >> 5) * 2)) + (i_8 & 1))] = condval_3;
        }
      } else {
          ...
          for (int i_9 = 0; i_9 < 32; ++i_9) {
            *(float2*)(acc_s + (i_9 * 2)) = make_float2(0x0p+0f/*0.000000e+00*/, 0x0p+0f/*0.000000e+00*/);
            ...
            for (int i_11 = 0; i_11 < 64; ++i_11) {
              ...
              acc_s[(((((i_11 & 31) >> 1) * 4) + ((i_11 >> 5) * 2)) + (i_11 & 1))] = condval_5;
            }
        }
      }
      tl::fence_proxy_async();
...
extern "C" int call(half_t* __restrict__ Q, half_t* __restrict__ K, half_t* __restrict__ V, int* __restrict__ topk_indices, int* __restrict__ head_mapping, float topk_percent, half_t* __restrict__ Output, int batch, int seq_len, int topk_num, cudaStream_t stream=cudaStreamDefault) {
	...
	main_kernel<<<dim3((seq_len + 31) / 32, 8, batch), dim3(384, 1, 1), 163840, stream>>>(K, K_desc, Output, Q, V, V_desc, head_mapping, topk_indices, batch, seq_len, topk_num);
